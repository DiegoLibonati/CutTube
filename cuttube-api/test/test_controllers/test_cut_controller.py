...
class TestClipVideoEndpoint:
    ...
    def test_clip_video_returns_200_on_success(self, mock_video_service: MagicMock, client: FlaskClient) -> None:
    ...
    @patch("src.controllers.cut_controller.VideoTubeService")
    def test_clip_video_returns_correct_structure(self, mock_video_service: MagicMock, client: FlaskClient) -> None:
        mock_instance = MagicMock()
        mock_instance.get_video_from_youtube.return_value = ("Success", True)
        mock_instance.name = "Test Video"
        mock_instance.filename = "test_filename"
    ...
    @patch("src.controllers.cut_controller.VideoTubeService")
    def test_clip_video_returns_correct_code(self, mock_video_service: MagicMock, client: FlaskClient) -> None:
        mock_instance = MagicMock()
        mock_instance.get_video_from_youtube.return_value = ("Success", True)
        mock_instance.name = "Test Video"
        mock_instance.filename = "test_filename"
    ...
    @patch("src.controllers.cut_controller.VideoTubeService")
    def test_clip_video_returns_409_when_video_load_fails(self, mock_video_service: MagicMock, client: FlaskClient) -> None:
        mock_instance = MagicMock()
    ...
    @patch("src.controllers.cut_controller.VideoTubeService")
    def test_clip_video_returns_conflict_code_when_fails(self, mock_video_service: MagicMock, client: FlaskClient) -> None:
        mock_instance = MagicMock()
        mock_instance.get_video_from_youtube.return_value = (
            "Error loading video",
            False,
    ...
    def test_clip_video_returns_400_with_invalid_body(self, client: FlaskClient) -> None:
        response = client.post(
            "/api/v1/cut/test_filename/clip",
    ...
    @patch("src.controllers.cut_controller.VideoTubeService")
    def test_clip_video_calls_generate_clip(self, mock_video_service: MagicMock, client: FlaskClient) -> None:
        mock_instance = MagicMock()
        mock_instance.get_video_from_youtube.return_value = ("Success", True)
        mock_instance.name = "Test Video"
        mock_instance.filename = "test_filename"
...
class TestDownloadClipEndpoint:
    ...
    @patch("src.controllers.cut_controller.FileService")
    def test_download_clip_returns_404_when_file_not_found(self, mock_file_service: MagicMock, client: FlaskClient) -> None:
    ...
    @patch("src.controllers.cut_controller.FileService")
    def test_download_clip_returns_not_found_code(self, mock_file_service: MagicMock, client: FlaskClient) -> None:
        mock_file_service.path_exists.return_value = False
...
class TestRemoveClipEndpoint:
    @patch("src.controllers.cut_controller.FileService")
    def test_remove_clip_returns_200_on_success(self, mock_file_service: MagicMock, client: FlaskClient) -> None:
        mock_file_service.path_exists.return_value = True
    ...
    @patch("src.controllers.cut_controller.FileService")
    def test_remove_clip_returns_correct_structure(self, mock_file_service: MagicMock, client: FlaskClient) -> None:
        mock_file_service.path_exists.return_value = True
        mock_file_service.remove_file.return_value = None
    ...
    @patch("src.controllers.cut_controller.FileService")
    def test_remove_clip_returns_correct_code(self, mock_file_service: MagicMock, client: FlaskClient) -> None:
        mock_file_service.path_exists.return_value = True
        mock_file_service.remove_file.return_value = None
    ...
    @patch("src.controllers.cut_controller.FileService")
    def test_remove_clip_returns_404_when_file_not_found(self, mock_file_service: MagicMock, client: FlaskClient) -> None:
        mock_file_service.path_exists.return_value = False
    ...
    @patch("src.controllers.cut_controller.FileService")
    def test_remove_clip_returns_not_found_code(self, mock_file_service: MagicMock, client: FlaskClient) -> None:
        mock_file_service.path_exists.return_value = False
    ...
    @patch("src.controllers.cut_controller.FileService")
    def test_remove_clip_calls_remove_file(self, mock_file_service: MagicMock, client: FlaskClient) -> None:
        mock_file_service.path_exists.return_value = True
        mock_file_service.remove_file.return_value = None
